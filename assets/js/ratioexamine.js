...
d3.csv("https://raw.githubusercontent.com/ablinn91/Project-Books/master/books%20with%20no%20blanks%20greater%20than%20100%20text%20reviwes.csv").then(function (BookData) {
    ...
    var yLinearScale = d3.scaleLinear()
        .domain([(d3.min(BookData, d => (d.text_reviews_count/d.ratings_count))), d3.max(BookData, d => (d.text_reviews_count/d.ratings_count))])
        .range([height, 0]);
    ...
    var circleGroup = chartGroup.selectAll("circle")
        ...
        .attr("cy", d => yLinearScale(d.text_reviews_count/d.ratings_count))
        .attr("r", "4")
        .style("fill", "blue")
        .style("opacity", 0.4)
    ...
    var toolTip = d3.tip()
        ...
        .offset([80, -60])
        .html(function (d) {
            return (`${d.title}<br>Average Rating: ${d.average_rating}<br>Fraction of Text Reviews: ${(d.text_reviews_count/d.ratings_count )}`);
        });
